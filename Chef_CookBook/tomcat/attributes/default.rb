...
when "centos","redhat","fedora","amazon"
  ...
  #Modified for correct key tool path to generate the valid authentication certificate
  #default['tomcat']['keytool'] = 'keytool'
  override['tomcat']['keytool'] = "/usr/lib/jvm/java-1.7.0-openjdk-1.7.0.51.x86_64/bin/keytool"
