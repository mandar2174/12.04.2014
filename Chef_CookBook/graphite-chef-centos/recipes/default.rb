...
if node['platform_version'].to_i >= 6.0
  ...
  execute "Install epel" do
    command "rpm -Uvh https://dl.fedoraproject.org/pub/epel/6/x86_64/epel-release-6-8.noarch.rpm"
...
### Update fot Aricloud #####
ruby_block "update_util" do
  block do
    file = Chef::Util::FileEdit.new("/opt/graphite/lib/carbon/util.py")
    file.search_file_replace("from twisted.scripts._twistd_unix ", "")
    file.write_file
  end
end
