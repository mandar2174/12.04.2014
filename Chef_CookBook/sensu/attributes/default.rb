...
####################
#For aricloud changes because rabbit mq installed on 142 server 
#142 server name  = cloudclient.aricent.com
default.sensu.rabbitmq.host = "cloudclient.aricent.com"
...
# redis
default.sensu.redis.host = "cloudclient.aricent.com"
default.sensu.redis.port = 6379

# api
default.sensu.api.host = "cloudclient.aricent.com"
default.sensu.api.bind = "0.0.0.0"
default.sensu.api.port = 4567

# dashboard
default.sensu.dashboard.host = "cloudclient.aricent.com"
