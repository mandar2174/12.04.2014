...
include_recipe "initial-update-vm::default"
...
############################################
#Modified for aricloud
#Copy the sensu server key and certificate to the sensu client to synch
#copy to /etc/sensu/ssl

include_recipe "sensu::sensu_server_key"

include_recipe "sensu::sensu_server_confd_setting"

include_recipe "sensu::sensu_client_checks"
